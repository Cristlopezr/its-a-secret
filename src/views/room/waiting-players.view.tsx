...
export const WaitingPlayersView = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-10 min-h-screen pt-20 pb-10 px-4'>
            ...
            <Card className='w-full max-w-2xl bg-background/50 backdrop-blur-sm border-violet-500/20'>
                <CardHeader>
            ...
            <div className={`flex flex-col items-center gap-4 p-6 rounded-2xl w-full max-w-2xl transition-all duration-300 ${
